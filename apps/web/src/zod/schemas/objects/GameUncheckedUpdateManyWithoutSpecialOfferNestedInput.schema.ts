...
const Schema: z.ZodType<Prisma.GameUncheckedUpdateManyWithoutSpecialOfferNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const GameUncheckedUpdateManyWithoutSpecialOfferNestedInputObjectSchema =
  Schema;
