...
const Schema: z.ZodType<Prisma.GameUncheckedCreateNestedManyWithoutSpecialOfferInput> =
  z
    .object({
      create: z
        .union([
...
export const GameUncheckedCreateNestedManyWithoutSpecialOfferInputObjectSchema =
  Schema;
