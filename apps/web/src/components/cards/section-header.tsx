...
export function SectionHeader({ title, viewAllLink = "#", showViewAll = true }: SectionHeaderProps) {
  return (
    <div className="flex items-center justify-between mb-6">
      <h2 className="ml-2 text-white bg-clip-text text-2xl font-bold text-transparent">{title}</h2>
      {showViewAll && (
        <Link
          href={viewAllLink}
