...
const Schema: z.ZodType<Prisma.GameUncheckedUpdateManyWithoutCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => GameUpsertWithWhereUniqueWithoutCategoryInputObjectSchema
          ),
          z
            .lazy(
              () => GameUpsertWithWhereUniqueWithoutCategoryInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => GameUpdateWithWhereUniqueWithoutCategoryInputObjectSchema
          ),
          z
            .lazy(
              () => GameUpdateWithWhereUniqueWithoutCategoryInputObjectSchema
...
export const GameUncheckedUpdateManyWithoutCategoryNestedInputObjectSchema =
  Schema;
